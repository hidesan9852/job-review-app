...
・待遇・勤務条件に関するアピール（例:「高時給」「時給1,000円」「残業なし」「年間休日120日以上」「土日祝のみOK」「短時間勤務」「オープニングスタッフ」「急募」）
・勤務地・所在地に関する情報（例:「大阪市」「〇〇駅前」等の地名。勤務地は別項目で記載するものであり、職種名とは無関係な情報としてNG）
・「簡単な仕事」等、具体性のない曖昧なアピール文言
・記号による装飾（例:「！」「♪」「★」「【】」などの強調記号）
・1求人に複数の職種名を並記すること（1求人＝1職種・1勤務地が原則）
